    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חן קרן לעסקים קטנים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7b01a313-bd41-479e-9a6c-7b681c54b14d',
                    name: data.name || '',
                    email: data.email || '',
